...
const Login = () => {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      console.log('Login component: Attempting Google sign in...');
      ...
      console.error('Login component: Google authentication error:', error);
      ...
      >
        ...
        <div className="auth-header">
          ...
          <p className="auth-subtitle">
            Sign in to your professional task management account
          </p>
        </div>
